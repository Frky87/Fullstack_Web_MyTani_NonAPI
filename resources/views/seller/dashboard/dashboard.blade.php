                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                                    <svg version="1.1" id="fi_600268" xmlns="http://www.w3.org/2000/svg"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                        viewBox="0 0 512.001 512.001" style="enable-background: new 0 0 512.001 512.001"
                                        xml:space="preserve"width="45" height="45">
                                        <g>
                                            <g>
                                                <path
                                                    d="M511.999,87.804c0-0.056-0.007-0.112-0.009-0.169c-0.006-0.223-0.019-0.443-0.045-0.661c-0.01-0.08-0.025-0.16-0.037-0.24
                ...
                <div class="col-xxl-3 col-md-6">
                    <div class="card info-card sales-card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" id="fi_3875734" data-name="Layer 1"
